...
Square.prototype.initBuffers = function()
{
    ...
    this.texCoords = [
      0, 0,
      Math.cos(this.texangle), Math.sin(this.texangle),
      - Math.sin(this.texangle), Math.cos(this.texangle),
      Math.cos(this.texangle) - Math.sin(this.texangle), Math.sin(this.texangle) + Math.cos(this.texangle)];
